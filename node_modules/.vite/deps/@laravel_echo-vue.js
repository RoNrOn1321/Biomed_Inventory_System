...
function B(n) {
  try {
    return Reflect.construct(String, [], n), true;
  } catch {
    return false;
  }
}
var C = class extends _ {
   ...
   */
  constructor(e, t, s) {
    super(), this.name = t, this.pusher = e, this.options = s, this.eventFormatter = new A(this.options.namespace), this.subscribe();
  }
  /**
...
var V = class extends _ {
   ...
   */
  constructor(e, t, s) {
    super(), this.events = {}, this.listeners = {}, this.name = t, this.socket = e, this.options = s, this.eventFormatter = new A(this.options.namespace), this.subscribe();
  }
  /**
   ...
   */
  on(e, t) {
    return this.listeners[e] = this.listeners[e] || [], this.events[e] || (this.events[e] = (s, i) => {
      this.name === s && this.listeners[e] && this.listeners[e].forEach((r) => r(i));
...
var m = class extends S {
   ...
   */
  channel(e) {
    return this.channels[e] || (this.channels[e] = new C(
      this.pusher,
      e,
      this.options
    )), this.channels[e];
...
var W = class {
  ...
  connect() {
    if (this.options.broadcaster === "reverb")
      ...
      this.connector = new R(this.options);
  ...
  connectorSupportsEncryptedPrivateChannels(e) {
    return e instanceof m || e instanceof R;
  }
  /**
   * Get the Socket ID for the connection.
   */
...
var b = () => Y();
var F = (n) => Array.isArray(n) ? n : [n];
var h = {};
var M = (n) => {
  if (h[n.id])
    return h[n.id].count += 1, h[n.id].connection;
  const e = z(n);
  return h[n.id] = {
    count: 1,
    connection: e
...
var z = (n) => {
  const e = b();
  return n.visibility === "presence" ? e.join(n.name) : n.visibility === "private" ? e.private(n.name) : e.channel(n.name);
};
var D = (n, e = false) => {
  h[n.id] && (h[n.id].count -= 1, !(h[n.id].count > 0) && (delete h[n.id], e ? b().leave(n.name) : b().leaveChannel(n.id)));
};
function E(n, e = [], t = () => {
}, s = [], i = "private") {
  const r = ref(t), c = ref(false);
  watch(
    () => t,
    (a) => {
      r.value = a;
  ...
  const d = {
    name: n,
    id: ["private", "presence"].includes(i) ? `${i}-${n}` : n,
    visibility: i
  }, l = M(d), f = Array.isArray(e) ? e : [e], o = () => {
    I();
  }, I = () => {
    c.value || (f.forEach((a) => {
      l.listen(a, r.value);
...
var te = (n, e = () => {
  ...
  const i = E(
    ...
    s,
    "private"
  ), r = F(t).map((o) => o.includes(".") ? [o, o.replace(/\./g, "\\")] : [o, o.replace(/\\/g, ".")]).flat(), c = ref(false), d = (o) => {
    c.value && (r.length === 0 || r.includes(o.type)) && e(o);
  }, l = () => {
    c.value || (i.channel().notification(d), c.value = true);
  }, f = () => {
    c.value && (i.channel().stopListeningForNotification(d), c.value = false);
  };
  return onMounted(() => {
    l();
  }), onUnmounted(() => {
...
var re = () => {
  const n = ref(b().connectionStatus());
  let e;
  return onMounted(() => {
    e = b().connector.onConnectionChange((t) => {
      n.value = t;
    });
  }), onUnmounted(() => {
    e == null || e();
...
export {
  ...
  re as useConnectionStatus,
  E as useEcho,
  ie as useEchoModel,
  te as useEchoNotification,
  ne as useEchoPresence,
  se as useEchoPublic
};
